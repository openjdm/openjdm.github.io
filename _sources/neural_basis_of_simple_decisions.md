...
discrimination task (see Figure 1). A participant (often a nonhuman primate) is positioned in
...
strength with which the dots’ movement is correlated (Figure 2). Additionally, they
...
*Figure 1*: Stages of the motion discrimination task. First, the subject
...
*Figure 2*: Examples of moving dot stimuli at different correlation levels.
...
significantly and reliably pushed the distribution of decisions towards
...
of these transformations. Shadlen and Newsome (1996) suggested that a subset
...
Accumulator Model (Usher and McClelland, 2001).

## Termination

Finally, a decision in progress must terminate in order to be realized as a
...
the decision-making process to end (terminate).
...
threshold was not crossed in that same area.
...
come to make an actual decision.
...
class="s1">https://doi.org/10.1038/341052a0.C</span>](https://doi.org/10.1038/341052a0.C).
...
class="s1">https://doi.org/10.1038/nature18617</span>](https://doi.org/10.1038/nature18617)
  
Shadlen, M. N., & Kiani, R. (2013). Decision making as a window on
cognition. *Neuron*, 80(3):791–806. [<span
class="s1">https://doi.org/10.1016/j.neuron</span>](https://doi.org/10.1016/j.neuron)
...
873–922. [<span
class="s1">https://doi.org/10.1162/neco.2008.12-06-420</span>](https://doi.org/10.1162/neco.2008.12-06-420)
...
108(3):550-592. 10.1037/0033-295X.108.3.550
